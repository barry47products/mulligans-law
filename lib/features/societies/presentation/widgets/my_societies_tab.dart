...
/// Widget displaying the user's societies
class MySocietiesTab extends StatefulWidget {
  const MySocietiesTab({super.key});

  @override
  State<MySocietiesTab> createState() => _MySocietiesTabState();
}

class _MySocietiesTabState extends State<MySocietiesTab> {
